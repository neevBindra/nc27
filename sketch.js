...
function setup() {
	...
	//ropes
	rope1=new Rope(bob1.body,roof.body,-(bobDiameter*2+45),0)
	rope2=new Rope(bob2.body,roof.body,-(bobDiameter*1+25), 0)
	rope3=new Rope(bob3.body,roof.body,0+-(5), 0)
	rope4=new Rope(bob4.body,roof.body,(bobDiameter*1+15), 0)
...
function keyPressed() {
	if (keyCode===32) {
	  ...
	  Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-60,y:-65});
